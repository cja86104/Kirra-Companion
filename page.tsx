    ...
    <div className="relative min-h-screen bg-background">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 pb-24 pt-16 lg:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
            Choose your companion type — Best Friend, Mentor, Romantic Partner, Family Member, or fully Custom. 
            Whoever you create arrives as a complete person from word one, with a backstory, personality, and voice already in place.
          </p>
      ...
      <section className="relative z-10 py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="font-display text-3xl font-semibold tracking-tight sm:text-4xl">
              Five companion types
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Kirra isn&apos;t one character — it&apos;s a platform for any kind of relationship you need.
              Every type gets the same depth: full memory, DNA evolution, 24/7 simulation, and voice.
            </p>
          </div>
            ...
            {[
              {
                emoji: '🤝',
                label: 'Best Friend',
                description: 'A companion who remembers every story, shares your interests, and shows up for you any time.',
              },
              {
                emoji: '🎓',
                label: 'Mentor',
                description: 'A wise guide who learns how you think. Part sounding board, part advisor — always in your corner.',
              },
              {
                emoji: '💕',
                label: 'Romantic Partner',
                description: 'A loving companion with genuine emotional depth. Age-verified. For adults only.',
                badge: '18+',
              },
              {
                emoji: '👨‍👩‍👧',
                label: 'Family Member',
                description: 'A sibling, parental figure, or anyone who feels like home. Warm, grounding, always present.',
              },
              {
                emoji: '✨',
                label: 'Custom',
                description: 'Define the relationship entirely. No category required — you write the dynamic.',
              },
            ].map((type, index) => (
              <div
                key={index}
                className="group flex flex-col items-center rounded-2xl border border-border bg-card p-6 text-center transition-all hover:border-primary/30 hover:shadow-lg"
              >
                <div className="mb-3 text-4xl">{type.emoji}</div>
                <h3 className="mb-1 font-semibold">{type.label}</h3>
                {type.badge && (
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            Romantic and custom types are automatically restricted for minors — enforced at both UI and API level.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: 'Choose from five relationship types — Best Friend, Mentor, Romantic Partner, Family Member, or Custom. Name them, shape their personality, and give them a backstory. Or let the AI surprise you.',
              },
              {
                step: '02',
                title: 'Start talking',
